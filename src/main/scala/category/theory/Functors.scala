...
object Functors {
  ...
  val maybeFunctor = new Functor[Maybe] {
  ...
  val zeroOrMoreFunctor = new Functor[ZeroOrMore] {
  ...
  val maybeApplicative = new Applicative[Maybe] {
  ...
  val zeroOrMoreApplicative = new Applicative[ZeroOrMore] {
  ...
  val zeroOrMore = new Monad[ZeroOrMore] {
